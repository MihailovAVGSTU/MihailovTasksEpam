...
/**
 * does http requests for signIn and signUp
 */
...
public class AuthorizationServlet extends AjaxServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (requestObject != null) {
            ...
            switch (action) {
                case "signIn":
                    doSingIn(JsonConverter.getUser(requestObject), responseObject);
                    break;
                case "signUp":
    ...
    private void doSingIn(User user, JSONObject response) {
